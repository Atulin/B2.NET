...
public class B2FileUploadContext
{
	...
	/// <summary>
	///     Un-used for upload requests, used in responses. Providing a BucketID here for upload will do nothing. The UploadUrl
	///     determines Bucket.
	/// </summary>
	...
	/// <summary>
	///     SHA1 Hash of the file. If provided, this will be appended to the end of the file bytes for B2 hash verification on
	///     upload.
	/// </summary>
	...
	///     The value should be a base 10 number which represents a UTC time when the original source file was last modified.
