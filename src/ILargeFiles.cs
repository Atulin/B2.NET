...
public interface ILargeFiles
{
	...
	/// <param name="cancelToken"></param>
	/// <returns></returns>
	Task<B2File> StartLargeFile(string fileName, B2FileRetentionSettings fileRetention, string contentType = "", string bucketId = "", Dictionary<string, string> fileInfo = null, CancellationToken cancelToken = default);
