...
public class LargeFileRequestGenerators
{
	...
	public static HttpRequestMessage GetUploadPartUrl(B2Options options, string fileId) => BaseRequestGenerator.PostRequest(Endpoints.GetPartUrl, JsonSerializer.Serialize(new { fileId }), options);
